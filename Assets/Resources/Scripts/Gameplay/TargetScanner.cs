...
namespace Jonathan
{
    ...
    public class TargetScanner
    {
        ...
        public ThirdPersonController Detect(Transform detector, bool useHeightDifference = false)
        {
            

            Vector3 eyePos = detector.position + Vector3.up * heightOffset;
            Vector3 toPlayer = Controller.transform.position - eyePos;
            Vector3 toPlayerTop = Controller.transform.position + Vector3.up * 1.5f - eyePos;
